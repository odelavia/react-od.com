    ...
    <div className="body-wrapper">
      ...
      <div className="body-text-container">
        ...
        <code className="line-4-text"><span className="html-object">ReactDOM</span><span className="html-method">.render</span>(</code>
          ...
          <code className="line-13-text pad1"><span className="html-object">document</span><span className="html-method">.getElementById</span>(<span className="html-path">'root'</span>),</code>
